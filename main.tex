...
\input{C2-Theory&TechnologyUsed}
\input{C3-SystemAnalysis}
\input{C4-SystemDesign}
\input{C5-Implemention}
\input{C6-Testing}
\input{C7-Conclusion}
...
\begin{thebibliography}{80}
    ...
    \bibitem{redis} \href{https://redis.io/docs/latest/develop/}{\color{black}Develop with Redis,\\https://redis.io/docs/latest/develop/}

    \bibitem{cloudinary} \href{https://cloudinary.com/documentation}{\color{black}Cloudinary documentation,\\https://cloudinary.com/documentation}
    ...
    \bibitem{render} \href{https://docs.render.com/}{\color{black}Render Quickstarts,\\https://docs.render.com/}
